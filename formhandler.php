...
$from='From: '. $email . "(" . $name . ")" . "\r\n" . 'Bcc: alyssa.jung@seattlecolleges.com' . "\r\n";
// sends bcc to alternate address 

//Creates intelligible subject line that shows where it came from
$subject = 'Email from the SECOND website'; // if your client has more than one web site, you can put the site name here.
...
mail ('alyssa.jung@seattlecolleges.com', $subject, $body, $from);
