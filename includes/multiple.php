...
#EDIT THE FOLLOWING:
$toAddress = "alyssacreates15@gmail.com";  //place your/your client's email address here
$toName = "Alyssa Jung"; //place your client's name here
$website = "alyssadom.com";  //place NAME of your client's website here
#--------------END CONFIG AREA ------------------------#
...
if ($response != null && $response->success)
    ...
    <div class="contact-feedback">
        ...
        <p>We'll respond via email within 48 hours, if your requested information requires a response.</p>
    </div>    
    <!-- END HTML FEEDBACK -->        
    <?php
...
?>
	...
	<div>	
		<label>
			...
			<select name="How_Did_You_Hear_About_Us?" required="required" title="How You Heard is required" tabindex="30">
				...
				<option value="A Friend">Referral</option>
	...
	<div>	
		<fieldset>
			...
			<input type="checkbox" name="Interested_In[]" value="Special Application" /> UX Research <br />
			<input type="checkbox" name="Interested_In[]" value="Lollipops" /> Logo Design <br />
